...
# save
#writeOGR(sp1, dsn= s.dir, layer= "GB_BOSS_fwd_fine_bathy_habitat_dominant_broad", driver="ESRI Shapefile", overwrite_layer=TRUE)
#write.csv(boss_dom, paste(dt.dir, "GB_BOSS_fwd_fine_bathy_habitat_dominant_broad.csv", sep='/'))

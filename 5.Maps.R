...
map2 <- map1 + tm_shape(gb)  + tm_borders(col ='black', lwd = 2) +
  tm_compass(type = "arrow", position = c(0.84, 0.30), size = 4) +
...
tmap_save(map2, paste(p.dir, "GB-Fine-BOSS-dwd.tiff", sep='/'))
tmap_save(map2, paste(p.dir, "GB-Fine-BOSS-dwd.png", sep='/'))



## Plot FINE FORWARD ----

pred <- raster(paste(o.dir, "GBpred-Fine-BOSS-fwd.tif", sep ='/'))
...
tmap_save(map2, paste(p.dir, "GB-Fine-BOSS-fwd.tiff", sep='/'))
tmap_save(map2, paste(p.dir, "GB-Fine-BOSS-fwd.png", sep='/'))


## Plot COARSE DOWNWARD ----

pred <- raster(paste(o.dir, "GBpred-coarese-BOSS-dwd.tif", sep ='/'))
...
tmap_save(map2, paste(p.dir, "GB-coarse-BOSS-dwd.tiff", sep='/'))
tmap_save(map2, paste(p.dir, "GB-coarse-BOSS-dwd.png", sep='/'))



## Plot COARSE FORWARD ----

pred <- raster(paste(o.dir, "GBpred-coarese-BOSS-fwd.tif", sep ='/'))
...
tmap_save(map2, paste(p.dir, "GB-coarse-BOSS-fwd.tiff", sep='/'))
tmap_save(map2, paste(p.dir, "GB-coarse-BOSS-fwd.png", sep='/'))
